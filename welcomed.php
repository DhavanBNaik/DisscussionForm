...
<body>
  ...
  <section class="intro">
    <nav class="navbar navbar-expand-lg">
      ...
      <div class="collapse navbar-collapse col-lg-6" id="navbarNavDropdown" >
        <ul class="navbar-nav" >
          ...
          <li class="nav-item">
            <a class="navig-link" href="profile.php" style="color: white;margin:20px;">Profile</a>
          </li>
          <li class="nav-item">
            <a href="viewQuesn.php" class="navig-link" style="color: white;margin:20px;">View Questions</a>
          </li>
          <li class="nav-item">
            <a href="askQsn.php" class="navig-link" style="color: white;margin:20px;">Ask Questions</a>
          </li>
          <li class="nav-item">
            <a class="navig-link" href="logout.php" style="color: white;margin:20px;">LogOut</a>
          </li>
    ...
    <div class="row title-content">
      <div class="col-lg-6 ">
        <h1 class="title-word">Welcome <?php echo $_SESSION['name'] ?><h1 class="subtitle">TO BMSCE DISCUSSION FORUM</h1>
        </h1>
      </div>
